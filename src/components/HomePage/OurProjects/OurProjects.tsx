    ...
    <section>
      <figure className=" relative h-[300px] md:h-[360px] lg:h-[600px]">
        ...
        <div className="absolute top-0 flex flex-col justify-center text-white text-center">
          <h2 className="mb-4 p-4 text-center text-2xl font-semibold text-white md:text-4xl lg:m-auto lg:mb-10 lg:w-4/5 lg:p-10 lg:text-6xl">
            NOS PROJETS
          </h2>
          <p className="m-auto w-4/5 text-center text-xs text-white shadow-sm md:text-xl lg:text-4xl">
